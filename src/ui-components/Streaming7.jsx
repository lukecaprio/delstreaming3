...
export default function Streaming7(props) {
  ...
  return (
    <Flex
      ...
      {...rest}
      {...getOverrideProps(overrides, "Streaming7")}
    >
      <Flex
        gap="24px"
        direction="column"
      ...
      >
        ...
        <Divider
          ...
          {...getOverrideProps(overrides, "Divider31493184")}
        ></Divider>
        <Divider
          height="1px"
          shrink="0"
          ...
          size="small"
          orientation="horizontal"
          {...getOverrideProps(overrides, "Divider31493188")}
        ></Divider>
        <Button
          display="flex"
          gap="0"
